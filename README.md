...
7. Ahora diríjase a la sección **Components**, ubique en el menú que se despliega la opción **VirtueMart** y haga click sobre ella.
...
2. Configure los siguientes campos:
	...
	* **VMPAYMENT_PAYCO_USER_ID**: Numero de usuario.
	* **VMPAYMENT_PAYCO_KEY**: Código asignado por ePayco.
	* **VMPAYMENT_PAYCO_DEBUG**: yes(para realizar pruebas) o no (pasar a producción).
